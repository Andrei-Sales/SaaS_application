...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        ...
        <div class="flex space-x-4">
            <a href="{{ route('invoices.index') }}" class="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-medium">
                View All Invoices
            </a>
            <a href="{{ route('invoices.create') }}" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium">
                Create New Invoice
            </a>
        </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            You're on the <strong>Free Plan</strong>. Upgrade to Pro to unlock unlimited invoices and more features.
                        </p>
                    </div>
                </div>
            </div>
